...
namespace Steam_Desktop_Authenticator
{
    public partial class ImportAccountForm : Form
    {
        ...
        bool DirectImport;
        string DirectID;
        string ImportUsingEncriptionKey;
        OpenFileDialog openFileDialog1;

        public ImportAccountForm(bool DirectImp = false, string DirectSteamID = "")
        {
            InitializeComponent();
            this.mManifest = Manifest.GetManifest();
            DirectImport = DirectImp;
            DirectID = DirectSteamID;
        ...
        public void InitProceed()
        {
            ...
            string ManifestFile = Application.StartupPath + @"\maFiles\manifest.json";
            ...
            if (ContiuneImport == "1")
            {
                ...
                if (DirectImport)
                {
                    openFileDialog1.FileName = Application.StartupPath + @"\maFiles\" + DirectID + ".maFile";
                    ImportProceed();
                }
                else
                {
        ...
        public void ImportProceed()
        {
            ImportUsingEncriptionKey = txtBox.Text;
