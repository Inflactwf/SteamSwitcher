...
namespace Steam_Desktop_Authenticator
{
    public partial class WelcomeForm : Form
    {
        ...
        private void btnImportConfig_Click(object sender, EventArgs e)
        {
            ...
            folderBrowser.Description = "Выберите папку, где располагался старый SDA.";
            ...
            if (userClickedOK == DialogResult.OK)
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("This folder does not contain either a manifest.json or an maFiles folder.\nPlease select the location where you had Steam Switcher Authenticator installed.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
