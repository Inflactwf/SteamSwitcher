...
namespace Steam_Desktop_Authenticator
{
    public partial class InstallRedistribForm : Form
    {
        ...
        private void InstallProcess_Exited(object sender, EventArgs e)
        {
            if (inlineInstall)
            {
                MessageBox.Show("Install complete! You may need to restart Steam Switcher Authenticator to view trade confirmations.", "Visual C++ Redistributable 2013", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
